  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-gray-100">
      ...
      <div className="flex flex-col space-y-4 w-full max-w-md mb-8">
        <Link to="/register?redirect=/add-pet" className="w-full px-6 py-3 bg-blue-500 text-white text-center rounded-lg hover:bg-blue-600 transition">
          Я потерял животное
        </Link>

        <Link to="/register?redirect=/add-pet" className="w-full px-6 py-3 bg-green-500 text-white text-center rounded-lg hover:bg-green-600 transition">
          Я нашёл животное
        </Link>
      </div>
